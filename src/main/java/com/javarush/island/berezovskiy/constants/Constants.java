...
public class Constants {
    ...
    public static final String ISLAND_EXECUTOR_INVALID_INFORMATION = "Island executor is not completed";
    public static final String CELLS_EXECUTOR_INVALID_INFORMATION = "Cells executor is not completed";
