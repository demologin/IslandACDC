...
public class Rabbit extends Herbivore{
    ...
    public Rabbit(double weight, int maxAmount, int maxSpeed, double maxFoodWeight) {
        super(weight, maxAmount, maxSpeed, maxFoodWeight);
    }

    @Override
    public Organism clone() throws CloneNotSupportedException {
        return new Rabbit(this.weight, this.maxAmount, this.maxSpeed, this.maxFoodWeight);
    }
