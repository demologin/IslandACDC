...
@CreatureAnnotation(name="Sheep",weight = 70,maxCountPerCell = 140,speedPerCell = 3,requiredFood = 15)
public class Sheep extends Herbivore{
    public Sheep(String name, int weight, int speedPerCell, int requiredFood, Limit limit) {
