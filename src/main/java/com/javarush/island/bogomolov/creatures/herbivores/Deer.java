...
@CreatureAnnotation(name="Deer",weight = 300,maxCountPerCell = 20,speedPerCell = 4,requiredFood = 50)
public class Deer extends Herbivore{
    public Deer(String name, int weight, int speedPerCell, int requiredFood, Limit limit) {
